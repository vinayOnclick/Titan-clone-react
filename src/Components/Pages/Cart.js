                        ...
                        <div className="cart-item-section">
                          ...
                          <div className="row">
                            <div className="col-md-4 shipping-method">
                              <p>SHIPPING METHOD:</p>
                              <button className="home-delivery">
                                HOME DELIVERY
                              </button>
              ...
              <div className="sub-total">
                <div className="order-summary">
                  ...
                  <div className="order-menu">
                    <Link className="active">ENTER VOUCHER CODES</Link>
                ...
                <div className="row price-section">
                  <div className="col-md-6">
                    <span>Order Total ({cartTotalQuantity} items) </span>
                  </div>
                  <div className="col-md-6">
                    <span className="pay"> Rs. {cartTotalAmount}</span>
                  </div>
                  <div className="col-md-6">
                    <span>YOU PAY </span>
                  </div>
